...
{                                                                              }
{ Package: Mikhan.Util                                                         }
{ Types: TVerMajor, TVerMinor, TVerPatch, TSemVer                              }
...
{------------------------------------------------------------------------------}
{ This unit uses "Semantic Versioning 2.0.0" conception, for more info about   }
{ it, please see http://semver.org/.                                           }
{                                                                              }
...
{                                                                              }
{   - 0.1.0-debug  - initial (default) version for all new project.            }
{   - 1.2.15-debug - debug build of version 1.2.15.                            }
{   - 1.3.0        - release build of version 1.3.0.                           }
{                                                                              }
{ The initial (default) value of version is: 0.1.0                             }
{                                                                              }
...
{ Several examples:                                                            }
{                                                                              }
{   - Name 0.1.0-debug = Code 1000                                             }
{   - Name 0.1.8.debug = Code 1008                                             }
{   - Name 2.5.17      = Code 205017                                           }
{   - Name 99.88.777   = Code 9988777                                          }
{                                                                              }
{ The program version can be stored in separate file.                          }
{------------------------------------------------------------------------------}

UNIT Mikhan.Util.AppVersion;                                            { UNIT }
...
type
    ...
    public
        ...
        constructor Create(Debug: Boolean; Major: TVerMajor;
            Minor: TVerMinor; Patch: TVerPatch); overload; virtual;
    end;
...
begin
    inherited Create();
    Self.Create(Debug, 0, 1, 0); // The default app version is 0.1.0
end;

constructor TSemVer.Create(Debug: Boolean; Major: TVerMajor;
    Minor: TVerMinor; Patch: TVerPatch);
begin
    inherited Create();
    FDebug := Debug;
    FMajor := Major;
