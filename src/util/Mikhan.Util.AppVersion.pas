...
{-------------------------------------------------------------------------}
{ This unit uses "Semantic Versioning 2.0.0" conception, for more         }
{ information about it, please see http://semver.org/.                    }
{                                                                         }
...
{                                                                         }
{   - 0.1.0.debug-master - initial (default) version for all new project  }
{     (without any commits and on default branch)                         }
{                                                                         }
{   - 1.2.15.debug-master-94604e3 - debug build of version 1.2.15, where  }
{     latest commit id is 94604e3                                         }
{                                                                         }
{   - 1.3.0.master-94604e3 - release build of version 1.3.0 where latest  }
{     commit id is 94604e3                                                }
{                                                                         }
